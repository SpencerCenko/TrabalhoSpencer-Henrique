...
def log():
    ...
    if(e1 == userNome and e2 == userSenha): 
        ...
        def delete():
            nome = nome2.get()
            querydelete = "delete from cardapio where nome=?"
            cursor.execute("delete from cardapio where nome='teste'")
        ...
        tk.Button(jsecundaria,text='delete',command=delete).place(x=170,y=130)#botao de delete
    else:
